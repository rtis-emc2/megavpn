...
func Load() Config {
	...
	return Config{
		...
		Agent: AgentConfig{
			...
			TLSCAFile:         strings.TrimSpace(getEnv("MEGAVPN_AGENT_TLS_CA_FILE", "")),
			TLSCertFile:       strings.TrimSpace(getEnv("MEGAVPN_AGENT_TLS_CERT_FILE", "")),
			TLSKeyFile:        strings.TrimSpace(getEnv("MEGAVPN_AGENT_TLS_KEY_FILE", "")),
			AllowInsecureHTTP: getEnvBool("MEGAVPN_AGENT_ALLOW_INSECURE_HTTP", false),
