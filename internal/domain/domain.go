...
// VLESSAccessPolicy is the runtime policy projection of a canonical
// ClientAccessGroup. It is not a separately persisted registry.
type VLESSAccessPolicy struct {
	Key              string           `json:"key"`
	Label            string           `json:"label"`
	Description      string           `json:"description"`
