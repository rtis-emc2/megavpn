...
type Store interface {
	...
	CreateManagedPlatformCertificateAuthority(context.Context, string, string, string) (domain.PlatformCertificate, error)
	...
	CreateManagedPlatformServicePKIRoot(context.Context, string, string, string) (domain.PlatformServicePKIRoot, error)
