...
func servicePackDefinitions() []servicePackDefinition {
	return []servicePackDefinition{
		...
		},
		{
			...
			Components: []servicePackComponent{
				{Label: "Xray VLESS / Reality", Description: "Прямой публичный transport без edge companion.", ServiceCode: "xray-core", PresetKey: "reality_tcp", NameSuffix: "xray-reality", SlugSuffix: "xray-reality", EndpointPort: 443, RequiresEndpointHost: true, Spec: map[string]any{"service_profile": "reality_tcp", "security": "reality", "network": "tcp", "dest": "www.cloudflare.com:443", "fingerprint": "chrome", "egress_mode": "auto", "default_vless_group": "default", "vless_groups": defaultVLESSOutboundGroups(), "config_mode": "0640"}},
			},
		},
		{
