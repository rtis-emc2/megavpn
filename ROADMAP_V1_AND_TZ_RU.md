...
Базовая версия кода: RTIS MegaVPN 7.0.1.6
...
`7.0.1.6` является boundary-релизом между feature expansion и production hardening. Цель этой ветки - не добавлять хаотично новые сервисы, а стабилизировать три слоя:
...
## 2.2 Product Roadmap After 7.0.1.6
...
## 11. Release 7.0.1.6 Closure

Цель релиза `7.0.1.6`: закрыть следующий production-hardening слой для
