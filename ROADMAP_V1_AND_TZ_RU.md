...
Базовая версия кода: RTIS MegaVPN 7.0.1.1
...
`7.0.1.1` является boundary-релизом между feature expansion и production hardening. Цель этой ветки - не добавлять хаотично новые сервисы, а стабилизировать три слоя:
...
## 2.2 Product Roadmap After 7.0.1.1
...
## 11. Release 7.0.1.1 Closure

Цель релиза `7.0.1.1`: исправить реальный отказ backhaul apply на чистых nodes, где WireGuard/OpenVPN runtime packages еще не установлены, и убрать конфликт одинаковых L3 tunnel CIDR между auto-start transport profiles.
