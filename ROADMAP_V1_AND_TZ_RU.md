...
- PostgreSQL migrations apply cleanly on empty DB and existing pre-beta DB.
...
| Phase | Focus | Result |
|---|---|---|
| Current beta baseline | CI, contracts, current-state docs | Reproducible engineering baseline |
...
## 11. Release 0.7.0.1-beta Closure
...
Что сознательно остается после текущего beta baseline:
