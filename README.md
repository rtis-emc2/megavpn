...
- [External provider egress](docs/EXTERNAL_EGRESS.md)
...
- Remote agent transport is HTTPS-only by default and supports private CA and
...
- authenticated SMTP requires TLS and generated action URLs require absolute
  HTTPS destinations, except explicit loopback development URLs.
