...
const smokeScript = path.join(rootDir, 'scripts', 'service-pack-smoke.sh');
const evidenceReportScript = path.join(rootDir, 'scripts', 'service-pack-evidence-report.js');
const stagedSmokeScript = path.join(rootDir, 'scripts', 'service-pack-staged-smoke.sh');
