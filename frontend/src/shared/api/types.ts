...
export type ClientAccessGroup = APIRecord & {
  ...
  external_egress_profile_id?: string | null;
};
...
export type ExternalEgressProtocol = APIRecord & {
  code: string;
  label: string;
  category: string;
...
export type ExternalEgressImportPreviewRequest = {
  protocol: string;
  format: string;
  content: string;
};

export type ExternalEgressImportPreview = APIRecord & {
  protocol: string;
  transport: string;
  endpoint_host: string;
  endpoint_port?: number;
  ...
  inline_blocks?: string[];
  warnings?: string[];
  normalized?: APIRecord;
};

export type ExternalEgressDeployment = APIRecord & {
  id: string;
  profile_id: string;
  node_id: string;
  node_name?: string;
...
export type ExternalEgressProfile = APIRecord & {
  id: string;
  profile_key?: string;
  display_name: string;
  description?: string;
...
export type ExternalEgressDeploymentInput = {
  node_id: string;
  desired_status?: string;
  routing_table?: string;
  route_metric?: number;
