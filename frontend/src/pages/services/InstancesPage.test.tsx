...
describe('InstancesPage', () => {
  ...
  it('links access-group management to the canonical Clients Groups workspace', async () => {
    await openInstance();
    expect(screen.queryByRole('tab', { name: 'Access groups' })).not.toBeInTheDocument();
    expect(screen.getByRole('link', { name: 'Open groups' })).toHaveAttribute('href', '/clients/groups');
