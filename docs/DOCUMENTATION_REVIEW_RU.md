...
| Текущий релиз не был виден в каждом основном документе | Оператор мог спутать текущий release baseline с историческими roadmap notes | Добавлен release banner `7.1.0.11` в поддерживаемые docs |
