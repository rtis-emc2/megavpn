...
| Текущий релиз не был виден в каждом основном документе | Оператор мог спутать текущий release baseline с историческими roadmap notes | Добавлен release banner `7.1.1.9` в поддерживаемые docs |
