...
| Текущий релиз не был виден в каждом основном документе | Оператор мог спутать текущий beta baseline с историческими roadmap notes | Добавлен release banner `0.7.0.1-beta` в поддерживаемые docs |
