...
| 5 | [Current release notes](releases/8.0.0-pre.2.md) | Current release baseline and notable changes |
...
| 19 | [Security review](SECURITY_REVIEW_8.0.0-pre.2.md) | Security and release review artifact |
| 20 | [Control Plane frontend](FRONTEND.md) | Supported React UI, build and deployment contract |
| 21 | [Database model](DATABASE_MODEL.md) | PostgreSQL ownership, normalization and retention invariants |
| 22 | [Russian roadmap](../ROADMAP_V1_AND_TZ_RU.md) | Russian roadmap companion |
...
| Release readiness | `docs/RELEASE_GATES.md`, `docs/SELF_TESTING.md`, `docs/releases/8.0.0-pre.2.md` | Release notes, release evidence, self-test and smoke gates. |
| Security | `docs/THREAT_MODEL.md`, `docs/RBAC_MATRIX.md` | Threat model, roles, permissions and privileged jobs. |
| Control Plane frontend | `frontend/`, `docs/FRONTEND.md`, `docs/FRONTEND_RU.md` | Single supported UI source, reproducible bundle and deployment boundary. |
...
| Firewall | `docs/FIREWALL.md`, `docs/FIREWALL_RU.md` | Managed firewall catalog, address groups, rules and node apply state. |
| Traffic accounting | `docs/TRAFFIC_ACCOUNTING.md`, `docs/TRAFFIC_ACCOUNTING_RU.md` | Aggregate counters, privacy boundary, signed agent ingest and retention. |
...
| Database model | `docs/DATABASE_MODEL.md`, `docs/DATABASE_MODEL_RU.md` | Canonical ownership, relational integrity, node-history retention and migration conventions. |
