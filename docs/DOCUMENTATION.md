...
| 5 | [Current release notes](releases/8.0.0-pre.1.md) | Current release baseline and notable changes |
...
| 19 | [Security review](SECURITY_REVIEW_8.0.0-pre.1.md) | Security and release review artifact |
...
| Release readiness | `docs/RELEASE_GATES.md`, `docs/SELF_TESTING.md`, `docs/releases/8.0.0-pre.1.md` | Release notes, release evidence, self-test and smoke gates. |
