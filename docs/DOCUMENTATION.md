...
| 5 | [Current release notes](releases/7.1.1.14.md) | Current release baseline and notable changes |
...
| 19 | [Security review](SECURITY_REVIEW_7.1.1.14.md) | Security and release review artifact |
...
| Release readiness | `docs/RELEASE_GATES.md`, `docs/SELF_TESTING.md`, `docs/releases/7.1.1.14.md` | Release notes, release evidence, self-test and smoke gates. |
