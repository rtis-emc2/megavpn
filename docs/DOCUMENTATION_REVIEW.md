...
| Release version was not visible in every primary document | Operators could confuse current release docs with historical roadmap notes | Added a `8.0.0-pre.1` release banner to maintained documentation files |
