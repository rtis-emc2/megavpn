...
Текущая точка фиксации: `0.6.7.1-alpha`.
...
3. Проверить OpenVPN path на тестовом сервере: create/apply instance, platform CA root, slug-scoped config, client provisioning, artifact download.
...
8. Вынести service driver contracts для OpenVPN/Xray/Nginx/IPsec.
