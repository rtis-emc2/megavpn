...
| 5 | [Release notes](releases/7.1.1.5.md) | Текущий release baseline и заметные изменения |
...
| 19 | [Security review](SECURITY_REVIEW_7.1.1.5.md) | Security и release review artifact |
...
| Release readiness | `docs/RELEASE_GATES.md`, `docs/SELF_TESTING.md`, `docs/releases/7.1.1.5.md` | Release notes, release evidence, self-test и smoke gates. |
