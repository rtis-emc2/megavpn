...
| 5 | [Release notes](releases/8.0.0-pre.2.md) | Текущий release baseline и заметные изменения |
...
| 19 | [Security review](SECURITY_REVIEW_8.0.0-pre.2.md) | Security и release review artifact |
...
| Release readiness | `docs/RELEASE_GATES.md`, `docs/SELF_TESTING.md`, `docs/releases/8.0.0-pre.2.md` | Release notes, release evidence, self-test и smoke gates. |
