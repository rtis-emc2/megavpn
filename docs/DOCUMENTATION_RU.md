...
| 5 | [Release notes](releases/8.0.0-pre.1.md) | Текущий release baseline и заметные изменения |
...
| 19 | [Security review](SECURITY_REVIEW_8.0.0-pre.1.md) | Security и release review artifact |
| 20 | [Frontend Control Plane](FRONTEND_RU.md) | Поддерживаемый React UI, сборка и deployment contract |
| 21 | [Модель базы данных](DATABASE_MODEL_RU.md) | PostgreSQL ownership, нормализация и retention invariants |
| 22 | [English roadmap](../ROADMAP_V1_AND_TZ.md) | Английская версия roadmap |
...
| Release readiness | `docs/RELEASE_GATES.md`, `docs/SELF_TESTING.md`, `docs/releases/8.0.0-pre.1.md` | Release notes, release evidence, self-test и smoke gates. |
| Security | `docs/THREAT_MODEL.md`, `docs/RBAC_MATRIX.md` | Threat model, roles, permissions и privileged jobs. |
| Frontend Control Plane | `frontend/`, `docs/FRONTEND.md`, `docs/FRONTEND_RU.md` | Единственный поддерживаемый UI, воспроизводимый bundle и deployment boundary. |
...
| Внешний VPN/proxy egress | `docs/EXTERNAL_EGRESS.md`, `docs/EXTERNAL_EGRESS_RU.md` | Import provider profiles, encrypted credentials, node deployment и routing выбранных групп. |
| Модель базы данных | `docs/DATABASE_MODEL.md`, `docs/DATABASE_MODEL_RU.md` | Канонические сущности, реляционная целостность, retention истории нод и правила миграций. |
