...
19. Продолжить routing hardening после baseline `Inspect route policy`: добавить rollback/remove stage для retired/disabled route policies, conntrack visibility, MTU/MSS clamp и telemetry route-policy unit с реальных nodes.
