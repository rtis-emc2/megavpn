...
- `backhaul_transports`: driver-specific profile, endpoint, tunnel addresses, interface name, health and applied timestamps.
- `backhaul_transport_secrets`: typed foreign-key relationships from a transport to encrypted `secret_refs` material.
