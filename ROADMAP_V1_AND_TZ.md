...
**Code baseline:** RTIS MegaVPN `7.0.1.36`
...
`7.0.1.36` continues the production-hardening line after the firewall,
...
## 14. Release 7.0.1.36 Closure

The goal of `7.0.1.36` is to close an operator-facing design defect in the
