...
`7.1.0.14` усиливает Firewall apply на обновленных PostgreSQL-инсталляциях:
lookup policy и address-list больше не смешивает UUID/text типы в prepared
statement, а миграция `000017_firewall_apply_schema_hardening` выравнивает
firewall constraints с runtime catalog model. Основной фокус:
