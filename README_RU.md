...
`7.1.0.1` - baseline понятности firewall и планирования релиза перед
production. Основной фокус:
...
- следующий инженерный фокус зафиксирован вокруг учета пользовательского
  трафика с retention минимум 180 дней до включения production collection;
